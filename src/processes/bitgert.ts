...
import { BITGERT_WS_URL } from '../env';
...
class BitGertProcess {
  ...
  constructor(latency: number = 10) {
    const provider = new Web3.providers.WebsocketProvider(<string>BITGERT_WS_URL, {
      clientConfig: {
...
const briseProcess = new BitGertProcess(15);

export default briseProcess;
